            ...
            <div className="bg-white rounded-lg shadow p-4 sm:p-6">
              ...
              >
                ...
                <div className="text-gray-500">
                  ...
                  <p className="text-base sm:text-lg">Click to select or drag and drop your current data CSV file here</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow p-4 sm:p-6">
              ...
              >
                ...
                <div className="text-gray-500">
                  ...
                  <p className="text-base sm:text-lg">Click to select or drag and drop your future data CSV file here</p>
                </div>
              </div>
