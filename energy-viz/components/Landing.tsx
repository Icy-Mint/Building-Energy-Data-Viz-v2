  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 border-b border-gray-200 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-3 flex flex-col sm:flex-row items-center justify-between gap-4">
          {/* Logo */}
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link className="text-sm text-gray-600 hover:text-gray-900 transition-colors py-2" href="/">Enterprise</Link>
            <Link className="text-sm text-gray-600 hover:text-gray-900 transition-colors py-2" href="/">Docs</Link>
            <Link className="text-sm text-gray-600 hover:text-gray-900 transition-colors py-2" href="/">Pricing</Link>
          </nav>
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden flex items-center justify-center h-[calc(100vh-theme('spacing.16'))] min-h-[600px]">
          ...
          <div className="mx-auto max-w-7xl px-4 relative z-10">
            <div className="text-center">
              ...
              <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
                <Link href="/upload" className="btn-brand">Import Data</Link>
                <Link href="/dashboard" className="btn-ghost">Get a Demo</Link>
              </div>
              {/* KPI row */}
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3 text-center max-w-sm sm:max-w-md mx-auto">
        ...
        <section className="mx-auto max-w-7xl px-4 pb-20 relative z-20 bg-white">
          <div className="space-y-0">
            ...
            <div className="w-full md:w-3/4 mx-auto">
              <div className="relative bg-white shadow-xl p-4 sm:p-6">
                <EnergyChart />
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 shadow-sm p-6 sm:p-8 h-auto lg:h-[28rem] flex flex-col justify-between">
              <div>
            ...
            <div className="bg-white border border-emerald-200 shadow-sm ring-1 ring-emerald-100 p-6 sm:p-8 h-auto lg:h-[28rem] flex flex-col justify-between">
              <div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                <Link href="/upload" className="inline-flex items-center rounded-lg bg-emerald-600 px-4 py-2 text-base text-white hover:bg-emerald-700 transition-colors">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                  </svg>
                  Upload Forecast CSV
                </Link>
                <Link href="/dashboard" className="inline-flex items-center rounded-lg border border-gray-300 px-4 py-2 text-base text-gray-700 hover:bg-gray-50 transition-colors">
                ...
                <div className="bg-white rounded-xl p-6 sm:p-8 shadow-lg">
                  <div className="text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      <Link href="/upload" className="btn-brand">Upload Data</Link>
                      <Link href="/dashboard" className="btn-ghost">View Demo</Link>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <footer className="border-t bg-white relative z-20">
        <div className="mx-auto max-w-7xl px-4 py-6 text-sm text-gray-600 flex flex-col sm:flex-row items-center justify-between gap-4">
          <span>© {new Date().getFullYear()} Building Energy Analysis</span>
          <p className="text-xs text-gray-500">We process uploaded CSV data only to generate your dashboards; nothing is stored long term.</p>
